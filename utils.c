...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/04 15:39:12 by md-aless          #+#    #+#             */
/*   Updated: 2022/04/04 15:39:16 by md-aless         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{	
	...
	v->path[14] = "./image/player_anm0.xpm";
	v->path[15] = "./image/player_anm1.xpm";
	v->path[16] = "./image/player_anm2.xpm";
	v->path[17] = "./image/player_anm3.xpm";
	v->path[18] = "./image/win.xpm";
